/*
 * CS 106B Huffman Encoding extension
 * This cpp file implements the lzw encoding function.
 */
...
const string DEFAULT_COMPRESSED_FILE_EXTENSION = ".lzw";
 ...
 */
void intro() {
    cout << "Welcome to CS 106B Shrink-It Extension!" << endl;
    cout << "This program uses the LZW coding algorithm for compression." << endl;
...
void test_convertToBinary() {
    int toConvert = getInteger("enter integer to convert: ");
    string binary = convertToBinary(toConvert);
    cout << binary << endl;
}
